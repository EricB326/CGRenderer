...
namespace uciniti
{
	...
	public:
		DirectionalLight();
		DirectionalLight(glm::vec3 a_light_direction, glm::vec3 a_light_rgb, glm::vec3 a_diffuse_rgb, glm::vec3 a_specular_rgb, float a_specular_intensity, float a_diffuse_intensity);
